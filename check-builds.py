...
KEY_ID     = os.environ.get("ASC_KEY_ID",     "WQLSW6398S")
ISSUER_ID  = os.environ.get("ASC_ISSUER_ID",  "cc920828-bbbd-40ca-9135-fb1a5c30dacd")
KEY_PATH   = os.environ.get("ASC_KEY_PATH",   os.path.expanduser("~/.appstoreconnect/private_keys/AuthKey_WQLSW6398S.p8"))
